...
module.exports = class Shader {
    ...
    constructor ( scene, options ) {
        ...
        var declareConstant = declarer( constants, 'c_' );
        ...
        this.scene.traverse( item => {
            ...
            if( item.update ) this.updatingItems.push( item );
    ...
    update () {
        ...
        this.time = ( Date.now() - this.startTime ) * .001;
        ...
        this.updatingItems.forEach( i => i.update(i, this) );
